...
import { createMockOdeme, createRevenueCatOdeme, PaywallYoneticisi } from '@medyanes360/odeme';
import {
...
export const odeme = REVENUECAT_AKTIF
  ? createRevenueCatOdeme({ entitlementId: REVENUECAT_ENTITLEMENT_ID })
  : createMockOdeme(REVENUECAT_URUNLER);
...
export { REVENUECAT_AKTIF, REVENUECAT_ENTITLEMENT_ID } from './revenuecat-yapilandirma';
