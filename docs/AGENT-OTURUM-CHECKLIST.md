...
- [ ] Sıradaki adımlar ve bekleyen görevler gözden geçirildi.
- [ ] Yapılacak iş SPEC / özellik isteği ile uyumlu mu kontrol edildi.

## Oturum sırasında

- [ ] Seviye 2/3 konular biriktirilmeden proje sahibine soruldu.
...
- [ ] Son işlerin `IS-AKIS` kayıtlarında commit hash'i güncellendi (push sonrası).
